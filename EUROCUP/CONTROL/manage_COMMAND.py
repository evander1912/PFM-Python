...
class Manage_COMMAND:
    ...
    detail_command = {
        ...
        'show': {
            ...
            "e.g": "show recommended/dangerous/all/... bets"
            },
        'hit':{
    ...
    def makebet_command(self, keyword_list):
        ...
        """Esta funcion se encarga de hacer los calculos pertienentes a las apuestas """
    ...
    def help_command(self, keyword_list):
        ...
        """Esta funcion se encarga de mostrar la ayuda para los comandos """
    ...
    def showed_items(self, my_json):
        ...
        """Muestra todos los datos necesarios """
...
=========================================================")
    ...
    def show_command(self, keyword_list):
        ...
        """Esta funcion llama a la funcion anterior para mostrar los datos """

        if (keyword_list[1].lower() == 'recommended') and (keyword_list[2].lower() == 'bets'):
            with open("./DATAS/FOOTBALL_DATAS/recommended_BETS.json", encoding="utf-8") as my_File:
            ...
            with open("./DATAS/FOOTBALL_DATAS/historical_BETS.json", encoding="utf-8") as my_File:
                my_json = json.load(my_File)
                if len(my_json["data"]) == 0:
            ...
            with open("./DATAS/FOOTBALL_DATAS/dangerous_BETS.json", encoding="utf-8") as my_File:
                my_json = json.load(my_File)
                if len(my_json["data"]) == 0:
            ...
            with open("./DATAS/FOOTBALL_DATAS/success_recommended_BETS.json", encoding="utf-8") as my_File:
                my_json = json.load(my_File)
                if len(my_json["data"]) == 0:
            ...
            with open("./DATAS/FOOTBALL_DATAS/failed_recommended_BETS.json", encoding="utf-8") as my_File:
                my_json = json.load(my_File)
                if len(my_json["data"]) == 0:
    ...
    def solo_command(self, command_line):
        ...
        """Esta funcion ejecuta los comandos solitarios como clean o help """
    ...
    def hit_command(self, keyword_list):
        ...
        """Este metodo muestra el porcetange de aciertos, errores .... """
    ...
    def resultbets_command(self, keyword_list):
        ...
        """ Guarda los resultados de los partidos tras haber finalizado"""
